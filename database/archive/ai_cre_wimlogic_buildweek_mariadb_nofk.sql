...
CREATE TABLE `cre_approved_design_baselines` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `baseline_uid` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `project_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `design_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `design_scope` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `active_scope_key` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when (`status` = _utf8mb4'active') then concat(`property_id`,_utf8mb4'|',`design_type`,_utf8mb4'|',`design_scope`) else NULL end)) STORED,
...
CREATE TABLE `cre_design_image_lineage` (
  ...
  `lineage_role` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'primary',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cre_design_image_versions` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `version_uid` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `design_job_id` bigint NOT NULL,
  `property_id` bigint NOT NULL,
...
CREATE TABLE `cre_design_job_images` (
  ...
  `input_role` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'primary',
...
CREATE TABLE `cre_design_jobs` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `job_prompt` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `job_constraints` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cre_design_tool_image_requirements` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tool_id` bigint NOT NULL,
  `input_role` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cre_design_tool_knowledge_rules` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tool_id` bigint NOT NULL,
  `knowledge_scope` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cre_design_tool_options` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tool_id` bigint NOT NULL,
  `option_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cre_design_tools` (
  ...
  `icon_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `business_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `business_instructions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
